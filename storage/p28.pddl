...
(:objects
	depot0-1-1 depot0-1-2 depot0-1-3 depot0-1-4 depot0-2-1 depot0-2-2 depot0-2-4 depot1-1-1 depot1-1-2 depot1-1-3 depot1-1-4 depot1-2-1 depot1-2-2 depot1-2-3 depot1-2-4 depot2-1-1 depot2-1-2 depot2-1-3 depot2-1-4 depot2-2-1 depot2-2-2 depot2-2-3 depot3-1-1 depot3-1-2 depot3-1-3 depot3-1-4 depot3-2-1 depot3-2-2 depot3-2-3 depot4-1-1 depot4-1-2 depot4-1-3 depot4-1-4 depot4-2-1 depot4-2-2 depot4-2-3 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 container-4-1 - storearea
...
(:init
	...
	(part_of depot1-1-4 depot1)
	(part_of depot1-2-1 depot1)
	(part_of depot1-2-2 depot1)
	(part_of depot1-2-3 depot1)
	(part_of depot1-2-4 depot1)
	(part_of depot2-1-1 depot2)
	(part_of depot2-1-2 depot2)
	(part_of depot2-1-3 depot2)
	(part_of depot2-1-4 depot2)
	(part_of depot2-2-1 depot2)
	(part_of depot2-2-2 depot2)
	(part_of depot2-2-3 depot2)
	(part_of depot3-1-1 depot3)
	(part_of depot3-1-2 depot3)
	(part_of depot3-1-3 depot3)
	(part_of depot3-1-4 depot3)
	(part_of depot3-2-1 depot3)
	(part_of depot3-2-2 depot3)
	(part_of depot3-2-3 depot3)
	(part_of depot4-1-1 depot4)
	(part_of depot4-1-2 depot4)
	(part_of depot4-1-3 depot4)
	(part_of depot4-1-4 depot4)
	(part_of depot4-2-1 depot4)
	(part_of depot4-2-2 depot4)
	(part_of depot4-2-3 depot4)
	...
	(part_of container-1-1 container1)
	(part_of container-1-2 container1)
	(part_of container-1-3 container1)
	(part_of container-2-0 container2)
	(part_of container-2-1 container2)
	(part_of container-2-2 container2)
	(part_of container-2-3 container2)
	(part_of container-3-0 container3)
	(part_of container-3-1 container3)
	(part_of container-3-2 container3)
	(part_of container-3-3 container3)
	(part_of container-4-0 container4)
	(part_of container-4-1 container4)
	...
	(connected depot0-2-4 loadarea)
	(connected loadarea depot0-2-4)
