...
(define (problem prob-001-027)
    (:domain e-step-gadget)
    (:objects
        r0 r1 r2 r3 r4 r5 r6 r7 r8 r9 r10 r11 r12 r13 r14 r15 r16 r17 r18 r19 r20 r21 r22 r23 r24 r25 r26 r27 - rank
        w1 - widget
    )
    (:init

        ;; (before r0 r1) (before r1 r2) (before r2 r3) 
        (before r0 r1) (before r1 r2) (before r2 r3) (before r3 r4) (before r4 r5) (before r5 r6) (before r6 r7) (before r7 r8) (before r8 r9) (before r9 r10) (before r10 r11) (before r11 r12) (before r12 r13) (before r13 r14) (before r14 r15) (before r15 r16) (before r16 r17) (before r17 r18) (before r18 r19) (before r19 r20) (before r20 r21) (before r21 r22) (before r22 r23) (before r23 r24) (before r24 r25) (before r25 r26) (before r26 r27)
